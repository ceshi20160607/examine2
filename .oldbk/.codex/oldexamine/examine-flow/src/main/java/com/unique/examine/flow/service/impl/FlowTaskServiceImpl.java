...
import com.unique.examine.flow.mapper.FlowTaskMapper;
...
public class FlowTaskServiceImpl extends ServiceImpl<FlowTaskMapper, FlowTask> implements IFlowTaskService {
     ...
     */
    @Override
    public FlowTask queryById(Serializable id) {
        return getById(id);
    }
    ...
    public void addOrUpdate(FlowTask entity) {
        saveOrUpdate(entity);
    }
     ...
     */
    @Override
    public BasePage<FlowTask> queryPageList(PageEntity search) {
