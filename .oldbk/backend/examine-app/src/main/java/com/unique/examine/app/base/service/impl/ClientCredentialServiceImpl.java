...
import com.unique.examine.app.base.mapper.ClientCredentialMapper;
...
public class ClientCredentialServiceImpl extends ServiceImpl<ClientCredentialMapper, ClientCredential>
        implements IClientCredentialService {
     ...
     */
    @Override
    public ClientCredential queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<ClientCredential> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<ClientCredential> queryPage(Page<ClientCredential> page) {
    ...
    public boolean addOrUpdate(ClientCredential entity) {
