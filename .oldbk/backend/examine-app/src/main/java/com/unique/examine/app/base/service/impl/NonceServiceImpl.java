...
import com.unique.examine.app.base.mapper.NonceMapper;
...
public class NonceServiceImpl extends ServiceImpl<NonceMapper, Nonce>
     ...
     */
    @Override
    public Nonce queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<Nonce> queryPage(Page<Nonce> page) {
    ...
    public boolean addOrUpdate(Nonce entity) {
