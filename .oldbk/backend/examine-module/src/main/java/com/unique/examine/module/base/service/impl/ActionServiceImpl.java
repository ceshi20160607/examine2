...
import com.unique.examine.module.base.mapper.ActionMapper;
...
public class ActionServiceImpl extends ServiceImpl<ActionMapper, Action>
     ...
     */
    @Override
    public Action queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<Action> queryPage(Page<Action> page) {
    ...
    public boolean addOrUpdate(Action entity) {
