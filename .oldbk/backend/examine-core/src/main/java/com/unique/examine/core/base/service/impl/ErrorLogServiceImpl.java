...
import com.unique.examine.core.base.mapper.ErrorLogMapper;
...
public class ErrorLogServiceImpl extends ServiceImpl<ErrorLogMapper, ErrorLog>
     ...
     */
    @Override
    public ErrorLog queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<ErrorLog> queryPage(Page<ErrorLog> page) {
    ...
    public boolean addOrUpdate(ErrorLog entity) {
