...
import com.unique.examine.plat.base.mapper.OperationMapper;
...
public class OperationServiceImpl extends ServiceImpl<OperationMapper, Operation>
     ...
     */
    @Override
    public IPage<Operation> queryPage(Page<Operation> page) {
    ...
    public boolean addOrUpdate(Operation entity) {
