...
public class InstanceServiceImpl extends ServiceImpl<InstanceMapper, Instance>
     ...
     */
    @Override
    public Instance queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<Instance> queryPage(Page<Instance> page) {
    ...
    public boolean addOrUpdate(Instance entity) {
