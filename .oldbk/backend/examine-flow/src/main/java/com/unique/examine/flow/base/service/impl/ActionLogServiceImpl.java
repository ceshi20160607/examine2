...
import com.unique.examine.flow.base.mapper.ActionLogMapper;
...
public class ActionLogServiceImpl extends ServiceImpl<ActionLogMapper, ActionLog>
     ...
     */
    @Override
    public ActionLog queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<ActionLog> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<ActionLog> queryPage(Page<ActionLog> page) {
    ...
    public boolean addOrUpdate(ActionLog entity) {
