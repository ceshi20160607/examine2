...
public class RedisImpl implements Redis {
    ...
    public boolean setNx(String key, Long timeout, Object value) {
        Boolean ifAbsent = redisTemplate.opsForValue().setIfAbsent(appendKeyPrefix(key), value, timeout, TimeUnit.SECONDS);
        if (ifAbsent == null) {
            return false;
        }
        return ifAbsent;
     ...
     *
     * @param key     key
     * @param hashKey map对象中的key
     * @return map
     */
    @SuppressWarnings("unchecked")
    @Override
    public <T> T getRedisMapKey(Object key, Object hashKey) {
        return (T) redisTemplate.opsForHash().get(appendKeyPrefix(key), hashKey);
    }
     ...
     */
    @Override
    public Boolean hashMapKey(Object key, Object hashKey) {
     ...
     */
    @Override
    public void rpushAll(String key, List<Object> value) {
        redisTemplate.opsForList().rightPushAll(appendKeyPrefix(key), value);
    }
    ...
    public void convertAndSend(String key, Object value) {
        ...
        redisTemplate.convertAndSend(appendKeyPrefix(key), value);
    }
