...
public enum FieldEnum {
    ...
    public static Integer getMysqlModuleType(String typeStr) {
        Integer ret = FieldEnum.TEXT.getType();
        switch (typeStr) {
            case "bigint":
            case "timestamp":
            case "longblob":
            case "int":
            case "tinyint":
                ret = FieldEnum.NUMBER.getType();
                break;
            case "datetime":
                ret = FieldEnum.DATETIME.getType();
                break;
            case "decimal":
            case "double":
                ret = FieldEnum.NUMBER_FLOAT.getType();
                break;
            case "date":
                ret = FieldEnum.DATE.getType();
                break;
            case "varchar":
            case "text":
            case "longtext":
            case "char":
                ret = FieldEnum.TEXT.getType();
                break;
            default:
        }
        return ret;
