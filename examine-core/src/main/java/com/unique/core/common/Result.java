...
public class Result<T> implements Serializable {
    ...
    private Result(ResultBaseCode resultCode) {
        this.code = resultCode.getCode();
        this.msg = resultCode.getMsg();
    }

    private Result(ResultBaseCode resultCode, String msg) {
        this.code = resultCode.getCode();
        this.msg = msg;
    }
    ...
    public static <T> Result<T> error(ResultBaseCode resultCode) {
    ...
    public static Result error(ResultBaseCode resultCode,String msg) {
