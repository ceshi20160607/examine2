...
async function run() {
  ...
  await waitFor(client, `JSON.stringify({ ok: !!document.querySelector('.runtime-shell') && (document.body.innerText || '').includes(${JSON.stringify(moduleName)}) && (document.body.innerText || '').includes('\u65b0\u5efa\u8bb0\u5f55') })`);
