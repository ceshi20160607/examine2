...
## F. 自治交付（AUTONOMOUS 必过）

- [ ] **无** `pending.md` 阻塞（或文件不存在）
- [ ] `resolution.md` 含全部 AUTO 裁决
- [ ] P0 HTML 数 / design-package P0 数 **= 100%**（禁止抽样停步）
- [ ] 已对照 [reference-case.md](../feedforward/reference-case.md) 或 `.cursor/knowledge/reference-case.md`
- [ ] learning-loop 已执行（有 gap 则 learnings 已写）
- [ ] `state.json` → `design_delivered: true`

## G. 内部 reviews（Agent 自写 6 文件）
...
- [ ] user-approval.md 已生成（`approved: false` 待可选浏览）
