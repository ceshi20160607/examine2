...
import com.unique.module.service.IModuleOperateService;
...
public class ModuleOperateController {
    ...
    */
    ...
    public Result<BasePage<Map<String, Object>>> queryPageList(@RequestBody SearchBO search) {
        ...
        BasePage<Map<String, Object>> mapBasePage = moduleOperateService.queryPageList(search);
    ...
    */
    ...
    public Result<List> queryFieldAdd(@RequestParam(value = "type", required = false) String type) {
        if (ObjectUtil.isNotEmpty(type)) {
            return Result.ok(moduleOperateService.queryField(null));
        }
        return Result.ok(moduleOperateService.queryFormField(null));
    }
    ...
    */
    ...
    public Result<List> queryFieldEdit(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id,
        ...
        if (ObjectUtil.isNotEmpty(type)) {
            List<ModuleField> collect = moduleOperateService.queryField(id).stream().filter(field -> !field.getFieldName().equals("ownerUserId")).collect(Collectors.toList());
            return Result.ok(collect);
        }
        return Result.ok(moduleOperateService.queryFormField(id));
    }
    /**
    * 保存数据
    *
    ...
    */
    @PostMapping("/add")
    @ApiOperation("保存数据")
    public Result<Map<String, Object>> add(@RequestBody ModuleOperate baseModel) {
        Map<String, Object> map = moduleOperateService.addOrUpdate(baseModel, false);
    ...
    */
    @PostMapping("/update")
    @ApiOperation("修改数据")
    public Result<Map<String, Object>> update(@RequestBody ModuleOperate baseModel) {
        Map<String, Object> map = moduleOperateService.addOrUpdate(baseModel, false);
        return Result.ok(map);
    }
    /**
    ...
    */
    ...
    public Result<Map<String, Object> > queryById(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        Map<String, Object>  model = moduleOperateService.queryById(id);
    ...
    */
    ...
    public Result<List<ModuleField>> information(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        ...
        List<ModuleField> information = moduleOperateService.information(id);
    ...
    */
    ...
    public Result deleteByIds(@ApiParam(name = "ids", value = "id列表") @RequestBody List<Long> ids) {
        moduleOperateService.deleteByIds(ids);
        return Result.ok();
    }
