...
public class ModuleGroupController {
    ...
    */
    ...
    public Result<BasePage<Map<String, Object>>> queryPageList(@RequestBody SearchBO search) {
        ...
        BasePage<Map<String, Object>> mapBasePage = moduleGroupService.queryPageList(search);
    ...
    */
    ...
    public Result<List> queryFieldAdd(@RequestParam(value = "type", required = false) String type) {
        if (ObjectUtil.isNotEmpty(type)) {
            return Result.ok(moduleGroupService.queryField(null));
        }
        return Result.ok(moduleGroupService.queryFormField(null));
    }
    ...
    */
    ...
    public Result<List> queryFieldEdit(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id,
        ...
        if (ObjectUtil.isNotEmpty(type)) {
            List<ModuleField> collect = moduleGroupService.queryField(id).stream().filter(field -> !field.getFieldName().equals("ownerUserId")).collect(Collectors.toList());
            return Result.ok(collect);
        }
        return Result.ok(moduleGroupService.queryFormField(id));
    }
    /**
    * 保存数据
    *
    ...
    */
    @PostMapping("/add")
    @ApiOperation("保存数据")
    public Result<Map<String, Object>> add(@RequestBody ModuleGroup crmModel) {
        Map<String, Object> map = moduleGroupService.addOrUpdate(crmModel, false);
    ...
    */
    @PostMapping("/update")
    @ApiOperation("修改数据")
    public Result<Map<String, Object>> update(@RequestBody ModuleGroup crmModel) {
        Map<String, Object> map = moduleGroupService.addOrUpdate(crmModel, false);
        return Result.ok(map);
    }
    /**
    ...
    */
    ...
    public Result<Map<String, Object> > queryById(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        Map<String, Object>  model = moduleGroupService.queryById(id);
    ...
    */
    ...
    public Result<List<ModuleField>> information(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        ...
        List<ModuleField> information = moduleGroupService.information(id);
