...
public class ModuleRoleController {
    ...
    */
    ...
    public Result<BasePage<Map<String, Object>>> queryPageList(@RequestBody SearchBO search) {
        ...
        BasePage<Map<String, Object>> mapBasePage = moduleRoleService.queryPageList(search);
    ...
    */
    ...
    public Result<List> queryFieldAdd(@RequestParam(value = "type", required = false) String type) {
        if (ObjectUtil.isNotEmpty(type)) {
            return Result.ok(moduleRoleService.queryField(null));
        }
        return Result.ok(moduleRoleService.queryFormField(null));
    }
    ...
    */
    ...
    public Result<List> queryFieldEdit(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id,
        ...
        if (ObjectUtil.isNotEmpty(type)) {
            List<ModuleField> collect = moduleRoleService.queryField(id).stream().filter(field -> !field.getFieldName().equals("ownerUserId")).collect(Collectors.toList());
            return Result.ok(collect);
        }
        return Result.ok(moduleRoleService.queryFormField(id));
    }
    /**
    * 保存数据
    *
    ...
    */
    @PostMapping("/add")
    @ApiOperation("保存数据")
    public Result<Map<String, Object>> add(@RequestBody ModuleRole baseModel) {
        Map<String, Object> map = moduleRoleService.addOrUpdate(baseModel, false);
    ...
    */
    @PostMapping("/update")
    @ApiOperation("修改数据")
    public Result<Map<String, Object>> update(@RequestBody ModuleRole baseModel) {
        Map<String, Object> map = moduleRoleService.addOrUpdate(baseModel, false);
        return Result.ok(map);
    }
    /**
    ...
    */
    ...
    public Result<Map<String, Object> > queryById(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        Map<String, Object>  model = moduleRoleService.queryById(id);
    ...
    */
    ...
    public Result<List<ModuleField>> information(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        ...
        List<ModuleField> information = moduleRoleService.information(id);
    ...
    */
    ...
    public Result deleteByIds(@ApiParam(name = "ids", value = "id列表") @RequestBody List<Long> ids) {
        moduleRoleService.deleteByIds(ids);
        return Result.ok();
    }
