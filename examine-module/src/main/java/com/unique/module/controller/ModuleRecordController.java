...
public class ModuleRecordController {
    ...
    */
    ...
    public Result<BasePage<Map<String, Object>>> queryPageList(@RequestBody SearchBO search) {
        ...
        BasePage<Map<String, Object>> mapBasePage = moduleRecordService.queryPageList(search);
    ...
    */
    ...
    public Result<List> queryFieldAdd(@RequestParam(value = "type", required = false) String type) {
        if (ObjectUtil.isNotEmpty(type)) {
            return Result.ok(moduleRecordService.queryField(null));
        }
        return Result.ok(moduleRecordService.queryFormField(null));
    }
    ...
    */
    ...
    public Result<List> queryFieldEdit(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id,
        ...
        if (ObjectUtil.isNotEmpty(type)) {
            List<ModuleField> collect = moduleRecordService.queryField(id).stream().filter(field -> !field.getFieldName().equals("ownerUserId")).collect(Collectors.toList());
            return Result.ok(collect);
        }
        return Result.ok(moduleRecordService.queryFormField(id));
    }
    /**
    * 保存数据
    *
    ...
    */
    @PostMapping("/add")
    @ApiOperation("保存数据")
    public Result<Map<String, Object>> add(@RequestBody ModuleRecord crmModel) {
        Map<String, Object> map = moduleRecordService.addOrUpdate(crmModel, false);
    ...
    */
    @PostMapping("/update")
    @ApiOperation("修改数据")
    public Result<Map<String, Object>> update(@RequestBody ModuleRecord crmModel) {
        Map<String, Object> map = moduleRecordService.addOrUpdate(crmModel, false);
        return Result.ok(map);
    }
    /**
    ...
    */
    ...
    public Result<Map<String, Object> > queryById(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        Map<String, Object>  model = moduleRecordService.queryById(id);
    ...
    */
    ...
    public Result<List<ModuleField>> information(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        ...
        List<ModuleField> information = moduleRecordService.information(id);
