...
public class ModuleFieldApiOpenController {
    ...
    */
    @PostMapping("/add")
    @ApiOperation("保存数据")
    public Result<Map<String, Object>> add(@RequestBody ModuleFieldApiOpen baseModel) {
        Map<String, Object> map = moduleFieldApiOpenService.addOrUpdate(baseModel, false);
    ...
    */
    @PostMapping("/update")
    @ApiOperation("修改数据")
    public Result<Map<String, Object>> update(@RequestBody ModuleFieldApiOpen baseModel) {
        Map<String, Object> map = moduleFieldApiOpenService.addOrUpdate(baseModel, false);
        return Result.ok(map);
    }
    /**
