 ...
 */
@RestController
@RequestMapping("/module-field-user")
@Api(tags = "自定义字段关联用户表")
public class ModuleFieldUserController {
    ...
    */
    ...
    public Result<BasePage<Map<String, Object>>> queryPageList(@RequestBody SearchBO search) {
        ...
        BasePage<Map<String, Object>> mapBasePage = moduleFieldUserService.queryPageList(search);
    ...
    */
    ...
    public Result<List> queryFieldAdd(@RequestParam(value = "type", required = false) String type) {
        if (ObjectUtil.isNotEmpty(type)) {
            return Result.ok(moduleFieldUserService.queryField(null));
        }
        return Result.ok(moduleFieldUserService.queryFormField(null));
    }
    ...
    */
    ...
    public Result<List> queryFieldEdit(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id,
        ...
        if (ObjectUtil.isNotEmpty(type)) {
            List<ModuleField> collect = moduleFieldUserService.queryField(id).stream().filter(field -> !field.getFieldName().equals("ownerUserId")).collect(Collectors.toList());
            return Result.ok(collect);
        }
        return Result.ok(moduleFieldUserService.queryFormField(id));
    }
    /**
    * 保存数据
    *
    ...
    */
    @PostMapping("/add")
    @ApiOperation("保存数据")
    public Result<Map<String, Object>> add(@RequestBody ModuleFieldUser crmModel) {
        Map<String, Object> map = moduleFieldUserService.addOrUpdate(crmModel, false);
    ...
    */
    @PostMapping("/update")
    @ApiOperation("修改数据")
    public Result<Map<String, Object>> update(@RequestBody ModuleFieldUser crmModel) {
        Map<String, Object> map = moduleFieldUserService.addOrUpdate(crmModel, false);
        return Result.ok(map);
    }
    /**
    ...
    */
    ...
    public Result<Map<String, Object> > queryById(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        Map<String, Object>  model = moduleFieldUserService.queryById(id);
    ...
    */
    ...
    public Result<List<ModuleField>> information(@PathVariable("id") @ApiParam(name = "id", value = "id") Long id) {
        ...
        List<ModuleField> information = moduleFieldUserService.information(id);
    ...
    */
    ...
    public Result deleteByIds(@ApiParam(name = "ids", value = "id列表") @RequestBody List<Long> ids) {
        moduleFieldUserService.deleteByIds(ids);
        return Result.ok();
    }
