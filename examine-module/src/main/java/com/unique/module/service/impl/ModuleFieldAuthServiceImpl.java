...
import com.unique.module.mapper.ModuleFieldAuthMapper;
 ...
 */
@Service
public class ModuleFieldAuthServiceImpl extends ServiceImpl<ModuleFieldAuthMapper, ModuleFieldAuth> implements IModuleFieldAuthService {
    ...
    */
    @Override
    public Map<String, Object> addOrUpdate(ModuleFieldAuth newModel, boolean isExcel) {
        Map<String, Object> map = new HashMap<>();
        if (ObjectUtil.isEmpty(newModel.getId())){
            save(newModel);
            //actionRecordUtil.addRecord(newModel.getId(), CrmEnum.CUSTOMER, newModel.getName());
        }else {
            ModuleFieldAuth  old = getById(newModel.getId());
    ...
    */
    ...
    public Map<String, Object> queryById(Long id) {
        LambdaQueryWrapper<ModuleFieldAuth> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(ModuleFieldAuth::getId, id);
