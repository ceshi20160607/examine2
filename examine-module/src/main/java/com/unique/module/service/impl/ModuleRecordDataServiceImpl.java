...
public class ModuleRecordDataServiceImpl extends ServiceImpl<ModuleRecordDataMapper, ModuleRecordData> implements IModuleRecordDataService {
    ...
    */
    @Override
    public Map<String, Object> addOrUpdate(ModuleRecordData newModel, boolean isExcel) {
        Map<String, Object> map = new HashMap<>();
        if (ObjectUtil.isEmpty(newModel.getId())){
            save(newModel);
            //actionRecordUtil.addRecord(newModel.getId(), CrmEnum.CUSTOMER, newModel.getName());
        }else {
            ModuleRecordData  old = getById(newModel.getId());
    ...
    */
    ...
    public Map<String, Object> queryById(Long id) {
        ...
        queryWrapper.eq(ModuleRecordData::getId, id);
