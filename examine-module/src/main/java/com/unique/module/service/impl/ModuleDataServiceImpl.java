...
import com.unique.module.mapper.ModuleDataMapper;
 ...
 */
@Service
public class ModuleDataServiceImpl extends ServiceImpl<ModuleDataMapper, ModuleData> implements IModuleDataService {
    ...
    */
    @Override
    public Map<String, Object> addOrUpdate(ModuleData newModel, boolean isExcel) {
        ...
        if (ObjectUtil.isEmpty(newModel.getId())){
            ...
            ModuleData  old = getById(newModel.getId());
            updateById(newModel);
    ...
    */
    ...
    public Map<String, Object> queryById(Long id) {
        LambdaQueryWrapper<ModuleData> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(ModuleData::getId, id);
