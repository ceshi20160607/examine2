...
import com.unique.module.mapper.ModuleRoleDataMapper;
 ...
 */
@Service
public class ModuleRoleDataServiceImpl extends ServiceImpl<ModuleRoleDataMapper, ModuleRoleData> implements IModuleRoleDataService {
    ...
    */
    @Override
    public Map<String, Object> addOrUpdate(ModuleRoleData newModel, boolean isExcel) {
        ...
        if (ObjectUtil.isEmpty(newModel.getId())){
            ...
            ModuleRoleData  old = getById(newModel.getId());
            updateById(newModel);
    ...
    */
    ...
    public Map<String, Object> queryById(Long id) {
        LambdaQueryWrapper<ModuleRoleData> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(ModuleRoleData::getId, id);
