...
public class ModuleRoleServiceImpl extends ServiceImpl<ModuleRoleMapper, ModuleRole> implements IModuleRoleService {
    ...
    */
    @Override
    public Map<String, Object> addOrUpdate(ModuleRole newModel, boolean isExcel) {
        ...
        if (ObjectUtil.isEmpty(newModel.getId())){
            ...
            ModuleRole  old = getById(newModel.getId());
            updateById(newModel);
    ...
    */
    ...
    public Map<String, Object> queryById(Long id) {
        LambdaQueryWrapper<ModuleRole> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(ModuleRole::getId, id);
