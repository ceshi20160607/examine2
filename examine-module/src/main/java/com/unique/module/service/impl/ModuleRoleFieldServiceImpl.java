...
import com.unique.module.mapper.ModuleRoleFieldMapper;
 ...
 */
@Service
public class ModuleRoleFieldServiceImpl extends ServiceImpl<ModuleRoleFieldMapper, ModuleRoleField> implements IModuleRoleFieldService {
    ...
    */
    @Override
    public Map<String, Object> addOrUpdate(ModuleRoleField newModel, boolean isExcel) {
        ...
        if (ObjectUtil.isEmpty(newModel.getId())){
            ...
            ModuleRoleField  old = getById(newModel.getId());
            updateById(newModel);
    ...
    */
    ...
    public Map<String, Object> queryById(Long id) {
        LambdaQueryWrapper<ModuleRoleField> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(ModuleRoleField::getId, id);
