...
import com.unique.module.mapper.ModuleOperateMapper;
 ...
 */
@Service
public class ModuleOperateServiceImpl extends ServiceImpl<ModuleOperateMapper, ModuleOperate> implements IModuleOperateService {
    ...
    */
    ...
    public Map<String, Object> queryById(Long id) {
        LambdaQueryWrapper<ModuleOperate> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(ModuleOperate::getId, id);
