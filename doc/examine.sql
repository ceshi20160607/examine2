...
`apply_type` int(10)  NULL DEFAULT '0' COMMENT '适用类型 0默认全公司 1用户 2部门',
`create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
`update_user_id` bigint(20) NULL DEFAULT NULL COMMENT '更新人',
`create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
`update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
`user_id` bigint(20) NULL DEFAULT NULL COMMENT '适用用户id',
`dept_id` bigint(20) NULL DEFAULT NULL COMMENT '适用部门id',
`create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人',
`update_user_id` bigint(20) NULL DEFAULT NULL COMMENT '更新人',
`create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
`update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
`examine_id` bigint(20) NULL DEFAULT NULL COMMENT '审批id--关联的审批的高级配置，以及审批的基础信息',
`module_id` bigint(20) NULL DEFAULT NULL COMMENT '模块id 关联模块--可以是业务，也可以是特殊的模块，比如oa',
`node_id` bigint(20) NULL DEFAULT NULL COMMENT '多人的情况下的父级id',
`node_before_id` bigint(20) NULL DEFAULT NULL COMMENT '审批的类型 0开始节点或者其他节点',
`node_type` int(11) NULL DEFAULT NULL COMMENT '审批的类型 0动态添加 1普通审批 2条件审批 3抄送 4转他人处理 ',
`node_sort` int(11) NULL DEFAULT '0' COMMENT '节点排序 默认0',
`node_depth` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '节点深度,存储节点的父级，从0开始逗号分隔',
...
`id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
`parent_id` bigint(20) NULL DEFAULT NULL COMMENT '父级id从0开始',
`depts` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '深度从0开始',

`transfer_flag` int(1) NULL DEFAULT 0 COMMENT '转他人处理flag 默认0 1表示这个是转他人的审批场景',

`record_id` bigint(20) NOT NULL COMMENT '审批id',
`record_node_id` bigint(20) NOT NULL COMMENT 'recordnode节点id',
...
`status` int(1) NULL DEFAULT NULL COMMENT '审批状态',
`remark` varchar(255) NULL DEFAULT NULL COMMENT '审批状态备注',

-- `transfer_flag` int(1) NULL DEFAULT 0 COMMENT '转他人处理flag 默认0 1表示这个是转他人的审批场景',
-- `transfer_user_id` bigint(20) NULL DEFAULT NULL COMMENT '类型是转他人对应的主键',
-- `transfer_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '转他人邮箱',
-- `transfer_status` int(1) NULL DEFAULT NULL COMMENT '类型是转他人 审批状态',
-- `transfer_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '转他人备注',
