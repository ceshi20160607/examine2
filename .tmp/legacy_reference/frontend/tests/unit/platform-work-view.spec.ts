...
function session() {
  useSessionStore().applyAuth({ account: { id: '7', username: 'member', displayName: 'Member' }, context: { type: 'PLATFORM', account: { id: '7', username: 'member', displayName: 'Member' }, permissionVersion: '1', permissions: ['platform.work.read', 'platform.work.manage', 'platform.task.manage'], shells: ['PLATFORM_RUNTIME'] , roleIds: [], dataScope: null, restrictedMode: 'NONE'}, systems: [] , tenants: [], firstSystemId: null})
}
