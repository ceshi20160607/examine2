...
function platform(permissions: string[]) {
  useSessionStore().applyAuth({
    ...
    context: { type: 'PLATFORM', account: { id: '1', username: 'owner', displayName: 'Owner' }, permissionVersion: '1', permissions, shells: ['PLATFORM_ADMIN'] , roleIds: [], dataScope: null, restrictedMode: 'NONE'},
    systems: [],
...
function system(permissions: string[]) {
  useSessionStore().applyAuth({
    account: { id: '1', username: 'owner', displayName: 'Owner' },
    context: { type: 'SYSTEM', systemId: '41', systemName: 'S', tenantId: '73', tenantName: 'T', memberId: '2', account: { id: '1', username: 'owner', displayName: 'Owner' }, permissionVersion: '1', permissions, shells: ['SYSTEM_ADMIN'] , roleIds: ['legacy-role-1'], dataScope: { id: 'legacy-scope-1', code: 'legacy_all', kind: 'ALL' }, restrictedMode: 'NONE'},
    systems: [],
