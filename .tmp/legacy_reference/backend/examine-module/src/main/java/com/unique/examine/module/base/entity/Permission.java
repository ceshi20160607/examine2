 ...
 * @since 2026-07-15
 */
@TableName("un_module_permission")
public class Permission implements Serializable {
    ...
    @TableField("registered_permission_id")
    private Long registeredPermissionId;
    ...
    public Long getRegisteredPermissionId() {
        return registeredPermissionId;
    }

    public void setRegisteredPermissionId(Long registeredPermissionId) {
        this.registeredPermissionId = registeredPermissionId;
    }
