...
@Component
@Profile("vnext")
public class VNextSessionCookieSupport {
    ...
    public VNextSessionCookieSupport(SecurityProperties properties) {
    ...
    public void write(HttpServletResponse response, IssuedSession issued) {
        ...
        add(response, cookie(
                REFRESH_COOKIE, issued.refreshToken(), issued.refreshTtl(), "/api/v1/auth", true
        ));
