...
CREATE TABLE `un_audit_operation` (
  ...
  `aggregate_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `actor_account_id` bigint DEFAULT NULL,
  `context_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_audit_security` (
  ...
  `account_hint` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `system_id` bigint DEFAULT NULL,
  `tenant_id` bigint DEFAULT NULL,
  `source_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `remote_address` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_collab_record_comment` (
  ...
  `body` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_event_channel_configuration` (
  ...
  `endpoint` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secret_ref` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timeout_ms` int NOT NULL DEFAULT '5000',
  `last_check_at` datetime(3) DEFAULT NULL,
  `last_check_status` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_check_trace_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_event_message_delivery_log` (
  ...
  `channel` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dedupe_key` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_path` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `attempt_count` int NOT NULL DEFAULT '1',
  `message_id` bigint DEFAULT NULL,
  `failure_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `failure_message` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `masked_destination` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `duration_ms` bigint DEFAULT NULL,
  `trace_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL,
  `completed_at` datetime(3) DEFAULT NULL,
...
CREATE TABLE `un_event_message_template` (
  ...
  `draft_title_template` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `draft_body_template` varchar(4000) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_event_message_template_version` (
  ...
  `body_template` varchar(4000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `channels_json` json NOT NULL,
  `allowed_variables_json` json NOT NULL,
...
CREATE TABLE `un_module_action` (
  ...
  `action_name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `action_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `placement` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `permission_code` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `confirm_message` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort_order` int NOT NULL DEFAULT '0',
  `desired_status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ENABLED',
...
CREATE TABLE `un_module_config_check` (
  ...
  `draft_checksum` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_module_config_check_issue` (
  ...
  `severity` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `issue_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `resource_type` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `resource_id` bigint DEFAULT NULL,
  `property_path` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `issue_message` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `un_module_config_check_issue` VALUES (2085922246618333185,2085920203721703426,2085922246542835714,'BLOCKER','NO_ENABLED_MODULE','ROOT',NULL,'modules','至少需要一个启用模块','创建或启用一个模块','2026-08-08 02:53:12.795');
...
CREATE TABLE `un_module_config_reference` (
  ...
  `target_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_module_config_root` (
  `id` bigint NOT NULL,
  `system_id` bigint NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CLEAN',
  `draft_revision` bigint NOT NULL DEFAULT '0',
  `draft_checksum` char(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `active_version_id` bigint DEFAULT NULL,
  `base_version_id` bigint DEFAULT NULL,
...
CREATE TABLE `un_module_config_version` (
  ...
  `snapshot_json` json NOT NULL,
  `snapshot_checksum` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `snapshot_size_bytes` bigint NOT NULL,
  `impact_report_json` json NOT NULL,
  `published_at` datetime(3) NOT NULL,
  `published_by` bigint NOT NULL,
  `publish_reason` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `un_module_definition` (
  ...
  `module_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `module_name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icon_key` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort_order` int NOT NULL DEFAULT '0',
  `desired_status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ENABLED',
...
CREATE TABLE `un_module_dictionary` (
  `id` bigint NOT NULL,
  `system_id` bigint NOT NULL,
  `dictionary_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dictionary_name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dictionary_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_module_dictionary_item` (
  ...
  `item_label` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `semantic_key` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color_value` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icon_key` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort_order` int NOT NULL DEFAULT '0',
  `depth_level` int NOT NULL DEFAULT '0',
  `depth_path` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_module_export_task` (
  ...
  `schema_version_id` bigint NOT NULL,
  `module_snapshot_id` bigint NOT NULL,
  `schema_checksum` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `result_filename` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_module_field` (
  ...
  `field_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `index_mode` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NONE',
  `desired_status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ENABLED',
  `property_json` json NOT NULL,
  `code_locked_at` datetime(3) DEFAULT NULL,
  `created_revision` bigint NOT NULL,
...
CREATE TABLE `un_module_import_batch` (
  ...
  `module_snapshot_id` bigint NOT NULL,
  `schema_checksum` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `import_mode` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `match_field_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_module_import_row` (
  ...
  `planned_action` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `row_status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `input_json` json NOT NULL,
...
CREATE TABLE `un_module_page` (
  ...
  `system_id` bigint NOT NULL,
  `module_id` bigint NOT NULL,
  `page_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `page_name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `page_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_default` tinyint(1) NOT NULL DEFAULT '0',
  `desired_status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ENABLED',
  `layout_json` json NOT NULL,
  `active_marker` varchar(160) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS ((case when ((`is_default` = 1) and (`desired_status` = _utf8mb4'ENABLED') and (`deleted_at` is null)) then concat(`system_id`,_utf8mb4':',`module_id`,_utf8mb4':',`page_type`) else NULL end)) STORED,
  `code_locked_at` datetime(3) DEFAULT NULL,
  `created_revision` bigint NOT NULL,
  `updated_revision` bigint NOT NULL,
  `created_at` datetime(3) NOT NULL,
...
CREATE TABLE `un_module_page_component` (
  ...
  `component_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sort_order` int NOT NULL DEFAULT '0',
...
CREATE TABLE `un_module_permission` (
  ...
  `permission_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_module_print_task` (
  ...
  `record_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `template_id` bigint NOT NULL,
...
CREATE TABLE `un_module_print_template` (
  ...
  `template_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `template_name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `desired_status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `paper_size` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `orientation` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_module_print_template_version` (
  ...
  `orientation` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `definition_json` json NOT NULL,
  `definition_checksum` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `published_at` datetime(3) NOT NULL,
  `published_by` bigint NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `un_module_record` (
  ...
  `module_snapshot_id` bigint NOT NULL,
  `logical_module_id` bigint NOT NULL,
  `record_no` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prior_status` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_module_record_index` (
  ...
  `record_status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `value_kind` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_module_record_relation` (
  ...
  `source_field_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RELATION',
  `source_field_scope` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RECORD',
...
CREATE TABLE `un_module_record_unique` (
  ...
  `record_status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency_code` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_key` char(3) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (coalesce(`currency_code`,_utf8mb4'---')) STORED,
...
CREATE TABLE `un_module_record_value` (
  ...
  `field_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `field_scope` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RECORD',
  `result_schema` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dependency_version_json` json DEFAULT NULL,
  `evaluator_version` smallint unsigned DEFAULT NULL,
  `recalculation_state` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `failure_correlation_id` varchar(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `ordinal` int NOT NULL DEFAULT '0',
  `string_value` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `value_hash` char(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hash_key_version` varchar(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `display_value` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL,
  `created_by` bigint NOT NULL,
  `updated_at` datetime(3) NOT NULL,
  `updated_by` bigint NOT NULL,
...
CREATE TABLE `un_module_reference_state` (
  ...
  `recalculation_state` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `failure_correlation_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` datetime(3) NOT NULL,
  `version` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `un_module_runtime_schema_field` (
  ...
  `field_name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `field_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `field_scope` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_module_sub_record` (
  ...
  `parent_field_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SUBTABLE',
  `parent_field_scope` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RECORD',
  `row_id` bigint NOT NULL,
  `client_row_key` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ordinal` int NOT NULL,
...
CREATE TABLE `un_module_sub_value` (
  ...
  `source_field_id` bigint NOT NULL,
  `logical_field_id` bigint NOT NULL,
  `column_field_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `column_field_scope` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SUBTABLE_COLUMN',
  `ordinal` int NOT NULL DEFAULT '0',
  `string_value` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `text_value` text COLLATE utf8mb4_unicode_ci,
  `decimal_value` decimal(38,10) DEFAULT NULL,
...
CREATE TABLE `un_plat_access_request` (
  ...
  `request_reason` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `decision_reason` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_plat_account` (
  `id` bigint NOT NULL,
  `account_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `username` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `username_normalized` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(254) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_normalized` varchar(254) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `display_name` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `locale` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'zh-CN',
  `time_zone` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Asia/Shanghai',
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_plat_account_role` (
  `id` bigint NOT NULL,
  `scope_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PLATFORM',
...
CREATE TABLE `un_plat_authz_epoch` (
  `id` bigint NOT NULL,
  `scope_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_plat_credential` (
  `id` bigint NOT NULL,
  `account_id` bigint NOT NULL,
  `credential_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password_hash` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password_algorithm` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password_parameters` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_plat_data_scope` (
  ...
  `scope_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `un_plat_data_scope` (`id`, `scope_type`, `scope_key`, `system_id`, `tenant_id`, `scope_code`, `name`, `scope_kind`, `field_rule_json`, `is_builtin`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`, `version`) VALUES (2085917351893340162,'PLATFORM',0,NULL,NULL,'platform_root_all','平台超级管理员全部数据','ALL',NULL,1,'ACTIVE','2026-08-08 02:33:45.508',2085917350597300225,'2026-08-08 02:33:45.508',2085917350597300225,NULL,NULL,0),(2085920203864309761,'SYSTEM',2085920203721703426,2085920203721703426,NULL,'system_owner_all','系统所有者全部数据','ALL',NULL,1,'ACTIVE','2026-08-08 02:45:05.748',2085917350597300225,'2026-08-08 02:45:05.748',2085917350597300225,NULL,NULL,0);
...
CREATE TABLE `un_plat_department` (
  ...
  `tenant_key` bigint GENERATED ALWAYS AS (coalesce(`tenant_id`,0)) STORED,
  `parent_id` bigint DEFAULT NULL,
  `department_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sort_order` int NOT NULL DEFAULT '0',
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL,
...
CREATE TABLE `un_plat_identity_auth_state` (
  ...
  `system_id` bigint DEFAULT NULL,
  `tenant_id` bigint DEFAULT NULL,
  `redirect_uri` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nonce` varchar(128) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
...
CREATE TABLE `un_plat_identity_binding` (
  ...
  `member_id` bigint DEFAULT NULL,
  `email_normalized` varchar(254) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_department_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_plat_identity_provider` (
  ...
  `issuer_uri` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `authorization_endpoint` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `token_endpoint` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jwks_uri` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `directory_endpoint` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `client_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secret_ref` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secret_version` varchar(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `callback_uri` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `scopes` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'openid profile email',
  ...
  `preflight_failure_code` varchar(96) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_plat_identity_sync_failure` (
  ...
  `failure_message` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `un_plat_identity_sync_item` (
  ...
  `parent_external_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_normalized` varchar(254) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `department_external_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `un_plat_member` (
  ...
  `system_id` bigint NOT NULL,
  `account_id` bigint NOT NULL,
  `member_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `display_name` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_plat_mfa_enrollment` (
  ...
  `secret_ref` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_plat_role` (
  ...
  `role_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `un_plat_role_permission` (
  ...
  `effect` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL,
  `created_by` bigint NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `un_plat_system` (
  ...
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tenant_mode` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `owner_account_id` bigint NOT NULL,
  `permission_version` bigint NOT NULL DEFAULT '1',
  ...
  `deleted_at` datetime(3) DEFAULT NULL,
  `deleted_by` bigint DEFAULT NULL,
  `tombstone_reason` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `un_plat_system` VALUES (2085920203721703426,'cycle118_acceptance','Cycle118 验收系统','用于最终功能、性能、可访问性与恢复演练','ACTIVE','SINGLE',2085917350597300225,1,'2026-08-08 02:45:05.748',NULL,NULL,'2026-08-08 02:45:05.748',2085917350597300225,'2026-08-08 02:45:05.748',2085917350597300225,NULL,NULL,NULL,NULL,1);
...
CREATE TABLE `un_plat_tenant_domain` (
  ...
  `domain_normalized` varchar(253) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (lower(trim(`domain_name`))) STORED,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_primary` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `un_sys_feature_flag` (
  ...
  `tenant_id` bigint DEFAULT NULL,
  `tenant_key` bigint GENERATED ALWAYS AS (coalesce(`tenant_id`,0)) STORED,
  `flag_key` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `un_sys_idempotency` VALUES (2085920203700731906,'PLATFORM_ADMIN','2085917350597300225:SYSTEM_CREATE:new','ae728d0f-42c6-4844-9fce-8d22f6760609','a343b7aab2a62860c81a7a0b55d2a1507ea45a8cf451d88618e0398678fc0fb3','COMPLETED',200,'OK','{\"id\":\"2085920203721703426\",\"code\":\"cycle118_acceptance\",\"name\":\"Cycle118 验收系统\",\"description\":\"用于最终功能、性能、可访问性与恢复演练\",\"status\":\"ACTIVE\",\"tenantMode\":\"SINGLE\",\"ownerAccountId\":\"2085917350597300225\",\"version\":\"1\",\"createdAt\":\"2026-08-08T02:45:05.748370576\"}','2026-08-08 02:47:05.741','2026-08-09 02:45:05.741','2026-08-08 02:45:05.741','2026-08-08 02:45:06.247');
...
-- Dump completed on 2026-08-08  3:31:50
