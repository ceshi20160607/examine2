...
$outLog = Join-Path $PSScriptRoot 'frontend-task-03-preview.out.log'
$errLog = Join-Path $PSScriptRoot 'frontend-task-03-preview.err.log'
$process = Start-Process -FilePath 'npm.cmd' `
    -ArgumentList 'run','preview','--','--host','127.0.0.1','--port','5175','--outDir','dist-p4-c4' `
