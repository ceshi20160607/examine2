-- Batch95 keeps the existing hash/count-only AI tool-call ledger and broadens
-- only the operation-name contract for bounded owner-enforced runtime reports.
