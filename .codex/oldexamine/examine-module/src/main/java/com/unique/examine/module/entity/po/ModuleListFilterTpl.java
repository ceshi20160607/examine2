...
@TableName("un_module_list_filter_tpl")
@Schema(name = "ModuleListFilterTpl对象", description = "列表筛选模板（可按菜单覆盖）")
public class ModuleListFilterTpl implements Serializable {

    private static final long serialVersionUID = 1L;

    @Schema(description = "筛选模板ID")
    ...
    @Schema(description = "un_module_menu.id；为空表示模型级默认模板")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long menuId;
