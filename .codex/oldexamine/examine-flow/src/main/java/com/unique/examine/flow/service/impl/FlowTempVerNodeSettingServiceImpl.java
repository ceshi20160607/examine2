...
import com.unique.examine.flow.mapper.FlowTempVerNodeSettingMapper;
...
/**
 * <p>
 * temp_ver-节点设置（setting；异常兜底覆盖） 服务实现类
 * </p>
 *
 * @author UNIQUE
 * @since 2026-04-21
 */
@Service
public class FlowTempVerNodeSettingServiceImpl extends ServiceImpl<FlowTempVerNodeSettingMapper, FlowTempVerNodeSetting> implements IFlowTempVerNodeSettingService {
