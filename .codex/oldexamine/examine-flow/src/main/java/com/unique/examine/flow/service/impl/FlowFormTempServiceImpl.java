...
import com.unique.examine.flow.mapper.FlowFormTempMapper;
 ...
 */
@Service
public class FlowFormTempServiceImpl extends ServiceImpl<FlowFormTempMapper, FlowFormTemp> implements IFlowFormTempService {
