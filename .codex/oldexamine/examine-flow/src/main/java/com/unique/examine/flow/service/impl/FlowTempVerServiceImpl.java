...
import com.unique.examine.flow.mapper.FlowTempVerMapper;
...
/**
 * <p>
 * 流程模板版本（temp_ver；原 definition_version） 服务实现类
 * </p>
 *
 * @author UNIQUE
 * @since 2026-04-21
 */
@Service
public class FlowTempVerServiceImpl extends ServiceImpl<FlowTempVerMapper, FlowTempVer> implements IFlowTempVerService {
