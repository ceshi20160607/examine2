-- Baseline: app DDL (converted from docs/sql/09_app_ddl.sql)
-- Note: migration should be safe; avoid DROP statements.
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

CREATE TABLE IF NOT EXISTS un_app_client (
...
CREATE TABLE IF NOT EXISTS un_app_client_credential (
...
CREATE TABLE IF NOT EXISTS un_app_client_scope (
...
CREATE TABLE IF NOT EXISTS un_app_ip_whitelist (
...
CREATE TABLE IF NOT EXISTS un_app_access_log (
