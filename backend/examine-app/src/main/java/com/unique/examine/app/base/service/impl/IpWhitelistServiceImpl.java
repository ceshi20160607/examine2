...
public class IpWhitelistServiceImpl extends ServiceImpl<IpWhitelistMapper, IpWhitelist>
     ...
     */
    @Override
    public IpWhitelist queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<IpWhitelist> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<IpWhitelist> queryPage(Page<IpWhitelist> page) {
    ...
    public boolean addOrUpdate(IpWhitelist entity) {
