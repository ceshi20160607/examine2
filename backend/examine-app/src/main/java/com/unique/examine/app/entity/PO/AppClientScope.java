...
@TableName("un_app_client_scope")
@Schema(name = "AppClientScope对象", description = "client 授权范围")
public class AppClientScope implements Serializable {
    ...
    @Schema(description = "授权范围编码（如 api:module:* / api:upload:read）")
