...
@TableName("un_app_ip_whitelist")
@Schema(name = "AppIpWhitelist对象", description = "client IP 白名单")
public class AppIpWhitelist implements Serializable {
    ...
    @Schema(description = "IP/CIDR（如 1.2.3.4 或 1.2.3.0/24）")
