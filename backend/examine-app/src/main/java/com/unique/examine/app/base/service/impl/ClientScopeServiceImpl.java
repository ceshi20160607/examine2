...
import com.unique.examine.app.base.mapper.ClientScopeMapper;
...
public class ClientScopeServiceImpl extends ServiceImpl<ClientScopeMapper, ClientScope>
        implements IClientScopeService {
     ...
     */
    @Override
    public ClientScope queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<ClientScope> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<ClientScope> queryPage(Page<ClientScope> page) {
    ...
    public boolean addOrUpdate(ClientScope entity) {
