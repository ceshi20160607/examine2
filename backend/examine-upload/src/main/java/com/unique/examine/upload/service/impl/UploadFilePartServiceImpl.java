...
import com.unique.examine.upload.mapper.UploadFilePartMapper;
 ...
 */
@Service
public class UploadFilePartServiceImpl extends ServiceImpl<UploadFilePartMapper, UploadFilePart> implements IUploadFilePartService {
