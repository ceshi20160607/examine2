...
import com.unique.examine.upload.base.mapper.StorageConfigMapper;
...
public class StorageConfigServiceImpl extends ServiceImpl<StorageConfigMapper, StorageConfig>
        implements IStorageConfigService {
     ...
     */
    @Override
    public StorageConfig queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<StorageConfig> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<StorageConfig> queryPage(Page<StorageConfig> page) {
    ...
    public boolean addOrUpdate(StorageConfig entity) {
