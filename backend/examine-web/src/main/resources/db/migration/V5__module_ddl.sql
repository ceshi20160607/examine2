-- Baseline: module DDL (converted from docs/sql/05_module_ddl.sql)
...
CREATE TABLE IF NOT EXISTS un_module_page (
  ...
  form_fields_json  JSON          NULL COMMENT '页面内表单字段级自定义（控件/校验/联动等）',
  status            TINYINT       NOT NULL DEFAULT 1 COMMENT '状态：1=启用 2=停用',
  create_user_id BIGINT        NULL COMMENT '创建人 platId',
  update_user_id BIGINT        NULL COMMENT '更新人 platId',
  create_time    DATETIME(3)   NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS un_module_page_block (
...
CREATE TABLE IF NOT EXISTS un_module_field (
  ...
  hidden_flag    TINYINT      NOT NULL DEFAULT 0 COMMENT '是否隐藏：1=隐藏 0=显示',
  ...
  multi_flag     TINYINT      NOT NULL DEFAULT 0 COMMENT '是否多选：1=多选 0=单选',
...
CREATE TABLE IF NOT EXISTS un_module_dict (
...
CREATE TABLE IF NOT EXISTS un_module_index (
...
CREATE TABLE IF NOT EXISTS un_module_relation (
...
CREATE TABLE IF NOT EXISTS un_module_record_data (
  ...
  value_text     MEDIUMTEXT   NULL COMMENT '字段值（字符串存储）',
  create_user_id BIGINT       NULL COMMENT '创建人 platId',
  update_user_id BIGINT       NULL COMMENT '更新人 platId',
  create_time    DATETIME(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  update_time    DATETIME(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='模型记录数据（EAV）';
...
CREATE TABLE IF NOT EXISTS un_module_role_menu_perm (
...
CREATE TABLE IF NOT EXISTS un_module_role_action_perm (
...
CREATE TABLE IF NOT EXISTS un_module_role_page_perm (
...
CREATE TABLE IF NOT EXISTS un_module_role_field_perm (
...
CREATE TABLE IF NOT EXISTS un_module_list_view (
...
CREATE TABLE IF NOT EXISTS un_module_list_view_col (
...
CREATE TABLE IF NOT EXISTS un_module_list_filter_tpl (
...
CREATE TABLE IF NOT EXISTS un_module_list_filter_field (
...
CREATE TABLE IF NOT EXISTS un_module_export_tpl (
...
CREATE TABLE IF NOT EXISTS un_module_export_tpl_field (
...
CREATE TABLE IF NOT EXISTS un_module_model_action (
...
CREATE TABLE IF NOT EXISTS un_module_integration (
...
CREATE TABLE IF NOT EXISTS un_module_integration_event (
...
CREATE TABLE IF NOT EXISTS un_module_integration_mapping (
