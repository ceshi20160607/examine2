...
class FlowWithdrawalRepositoryContractTest {
    @Test
    void optimisticSaveSqlKeepsPendingAndStateVersionCasForWithdrawal() {
    ...
    @Test
    void withdrawnInstanceLeavesPendingProjectionAndMayAppearCompleted() {
        var repository = new InMemoryApprovalRepository();
        var now = Instant.parse("2026-07-27T08:00:00Z");
        ...
        repository.saveInstance(pending.withdraw(10, "wrong amount", now.plusSeconds(60)));
        ...
        assertThat(repository.findApprovalTasks(20, ApprovalTaskStatus.COMPLETED, 0, 20))
                ...
                .containsExactly(ApprovalInstance.Status.WITHDRAWN);
    }
}
