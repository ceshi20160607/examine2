...
import com.unique.examine.flow.mapper.FlowRecordMapper;
...
/**
 * <p>
 * 流程实例记录（record；原 instance） 服务实现类
 * </p>
 *
 * @author UNIQUE
 * @since 2026-04-21
...
public class FlowRecordServiceImpl extends ServiceImpl<FlowRecordMapper, FlowRecord> implements IFlowRecordService {
     ...
     */
    @Override
    public FlowRecord queryById(Serializable id) {
        return getById(id);
    }
    ...
    public void addOrUpdate(FlowRecord entity) {
        saveOrUpdate(entity);
    }
     ...
     */
    @Override
    public BasePage<FlowRecord> queryPageList(PageEntity search) {
