...
@TableName("un_flow_temp_ver_line")
@Schema(name = "FlowTempVerLine对象", description = "temp_ver-连线（line；原 edge；关系表版）")
public class FlowTempVerLine implements Serializable {

    private static final long serialVersionUID = 1L;

    @Schema(description = "版本边ID")
    ...
    @Schema(description = "是否默认边：1=条件都不满足时的默认走向（非“异常兜底”）")
