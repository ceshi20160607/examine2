...
@TableName("un_flow_biz_binding")
@Schema(name = "FlowBizBinding对象", description = "业务与流程绑定")
public class FlowBizBinding implements Serializable {
    ...
    @Schema(description = "流程定义ID（un_flow_definition.id）")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long defId;
