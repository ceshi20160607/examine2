...
@TableName("un_flow_temp")
@Schema(name = "FlowTemp对象", description = "流程模板（temp；原 definition）")
public class FlowTemp implements Serializable {
