...
import com.unique.examine.flow.base.mapper.TemplateVersionMapper;
...
public class TemplateVersionServiceImpl extends ServiceImpl<TemplateVersionMapper, TemplateVersion>
     ...
     */
    @Override
    public TemplateVersion queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<TemplateVersion> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<TemplateVersion> queryPage(Page<TemplateVersion> page) {
    ...
    public boolean addOrUpdate(TemplateVersion entity) {
