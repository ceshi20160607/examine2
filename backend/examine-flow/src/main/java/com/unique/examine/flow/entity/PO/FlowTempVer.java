...
/**
 * <p>
 * 流程模板版本（temp_ver；原 definition_version）
 * </p>
 *
 * @author UNIQUE
 * @since 2026-04-21
...
@TableName("un_flow_temp_ver")
@Schema(name = "FlowTempVer对象", description = "流程模板版本（temp_ver；原 definition_version）")
public class FlowTempVer implements Serializable {
    ...
    @Schema(description = "un_flow_temp.id")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long tempId;
