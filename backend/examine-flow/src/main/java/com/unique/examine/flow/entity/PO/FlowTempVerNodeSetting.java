...
@TableName("un_flow_temp_ver_node_setting")
@Schema(name = "FlowTempVerNodeSetting对象", description = "temp_ver-节点设置（setting；异常兜底覆盖）")
public class FlowTempVerNodeSetting implements Serializable {

    private static final long serialVersionUID = 1L;

    @Schema(description = "版本节点策略ID")
