...
/**
 * <p>
 * record 变量/上下文（record_var；原 instance_variable）
 * </p>
 *
 * @author UNIQUE
 * @since 2026-04-21
...
@TableName("un_flow_record_var")
@Schema(name = "FlowRecordVar对象", description = "record 变量/上下文（record_var；原 instance_variable）")
public class FlowRecordVar implements Serializable {
    ...
    @Schema(description = "实例记录ID（un_flow_record.id）")
    @JsonSerialize(using = ToStringSerializer.class)
