...
@TableName("un_module_page")
@Schema(name = "ModulePage对象", description = "应用页面")
public class ModulePage implements Serializable {
    ...
    @Schema(description = "页面编码（同 app 内唯一）")
    private String pageCode;

    @Schema(description = "页面名称")
    private String pageName;

    @Schema(description = "页面类型：list|form|detail|custom")
    private String pageType;

    @Schema(description = "路由路径（前端使用，可选）")
