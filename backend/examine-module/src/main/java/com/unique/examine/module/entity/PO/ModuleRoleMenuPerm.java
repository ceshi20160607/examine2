...
@TableName("un_module_role_menu_perm")
@Schema(name = "ModuleRoleMenuPerm对象", description = "角色菜单权限")
public class ModuleRoleMenuPerm implements Serializable {
    ...
    @Schema(description = "un_module_menu.id")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long menuId;
