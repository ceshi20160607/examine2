...
import com.unique.examine.module.base.mapper.MemberTenantMapper;
...
public class MemberTenantServiceImpl extends ServiceImpl<MemberTenantMapper, MemberTenant>
        implements IMemberTenantService {
     ...
     */
    @Override
    public MemberTenant queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<MemberTenant> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<MemberTenant> queryPage(Page<MemberTenant> page) {
    ...
    public boolean addOrUpdate(MemberTenant entity) {
