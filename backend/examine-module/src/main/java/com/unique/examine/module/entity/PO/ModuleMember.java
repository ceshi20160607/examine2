...
@Schema(name = "ModuleMember对象", description = "应用成员")
public class ModuleMember implements Serializable {
    ...
    @Schema(description = "平台账号 platId")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long platId;

    @Schema(description = "角色ID（un_module_role.id，可为空）")
    @JsonSerialize(using = ToStringSerializer.class)
    private Long roleId;
