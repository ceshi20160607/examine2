...
import com.unique.examine.module.base.mapper.AppMapper;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>
     ...
     */
    @Override
    public App queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<App> queryPage(Page<App> page) {
    ...
    public boolean addOrUpdate(App entity) {
