...
import com.unique.examine.module.base.mapper.FieldOptionMapper;
...
public class FieldOptionServiceImpl extends ServiceImpl<FieldOptionMapper, FieldOption>
        implements IFieldOptionService {
     ...
     */
    @Override
    public FieldOption queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<FieldOption> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<FieldOption> queryPage(Page<FieldOption> page) {
    ...
    public boolean addOrUpdate(FieldOption entity) {
