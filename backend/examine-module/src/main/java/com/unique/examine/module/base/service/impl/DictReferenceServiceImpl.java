...
import com.unique.examine.module.base.mapper.DictReferenceMapper;
...
public class DictReferenceServiceImpl extends ServiceImpl<DictReferenceMapper, DictReference>
        implements IDictReferenceService {
     ...
     */
    @Override
    public DictReference queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<DictReference> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<DictReference> queryPage(Page<DictReference> page) {
    ...
    public boolean addOrUpdate(DictReference entity) {
