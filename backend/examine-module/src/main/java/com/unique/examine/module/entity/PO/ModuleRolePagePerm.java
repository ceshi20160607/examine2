...
@TableName("un_module_role_page_perm")
@Schema(name = "ModuleRolePagePerm对象", description = "角色页面权限")
public class ModuleRolePagePerm implements Serializable {

    private static final long serialVersionUID = 1L;

    @Schema(description = "页面权限ID")
