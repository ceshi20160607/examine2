...
import com.unique.examine.module.base.mapper.DictTypeMapper;
...
public class DictTypeServiceImpl extends ServiceImpl<DictTypeMapper, DictType>
     ...
     */
    @Override
    public DictType queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<DictType> queryPage(Page<DictType> page) {
    ...
    public boolean addOrUpdate(DictType entity) {
