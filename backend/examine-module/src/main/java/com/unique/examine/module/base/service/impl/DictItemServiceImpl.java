...
import com.unique.examine.module.base.mapper.DictItemMapper;
...
public class DictItemServiceImpl extends ServiceImpl<DictItemMapper, DictItem>
     ...
     */
    @Override
    public DictItem queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<DictItem> queryPage(Page<DictItem> page) {
    ...
    public boolean addOrUpdate(DictItem entity) {
