...
import com.unique.examine.module.base.mapper.SystemMenuMapper;
...
public class SystemMenuServiceImpl extends ServiceImpl<SystemMenuMapper, SystemMenu>
     ...
     */
    @Override
    public SystemMenu queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<SystemMenu> queryPage(Page<SystemMenu> page) {
    ...
    public boolean addOrUpdate(SystemMenu entity) {
