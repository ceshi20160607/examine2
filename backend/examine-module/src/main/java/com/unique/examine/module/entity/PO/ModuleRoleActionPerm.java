...
@TableName("un_module_role_action_perm")
@Schema(name = "ModuleRoleActionPerm对象", description = "角色动作权限（模块功能点）")
public class ModuleRoleActionPerm implements Serializable {

    private static final long serialVersionUID = 1L;

    @Schema(description = "动作权限ID")
    ...
    @Schema(description = "权限级别：1=允许 0=禁止")
