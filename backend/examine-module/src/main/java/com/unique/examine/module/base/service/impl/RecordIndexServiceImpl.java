...
import com.unique.examine.module.base.mapper.RecordIndexMapper;
...
public class RecordIndexServiceImpl extends ServiceImpl<RecordIndexMapper, RecordIndex>
        implements IRecordIndexService {
     ...
     */
    @Override
    public RecordIndex queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<RecordIndex> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<RecordIndex> queryPage(Page<RecordIndex> page) {
    ...
    public boolean addOrUpdate(RecordIndex entity) {
