...
public final class DataSourceException extends BusinessException {
    public DataSourceException(String code, String message) {
    ...
    private static HttpStatus status(String code) {
        if (code == null || code.isBlank()) {
            throw new IllegalArgumentException(
                    "Data source error code is required");
        }
