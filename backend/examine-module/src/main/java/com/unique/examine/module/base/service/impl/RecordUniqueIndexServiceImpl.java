...
import com.unique.examine.module.base.mapper.RecordUniqueIndexMapper;
...
public class RecordUniqueIndexServiceImpl extends ServiceImpl<RecordUniqueIndexMapper, RecordUniqueIndex>
        implements IRecordUniqueIndexService {
     ...
     */
    @Override
    public RecordUniqueIndex queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<RecordUniqueIndex> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<RecordUniqueIndex> queryPage(Page<RecordUniqueIndex> page) {
    ...
    public boolean addOrUpdate(RecordUniqueIndex entity) {
