...
@TableName("un_sys_idempotency_record")
@Schema(name = "IdempotencyRecord", description = "内部写接口幂等记录。")
public class IdempotencyRecord implements Serializable {
    ...
    @Schema(description = "INTERNAL；OpenAPI 使用专表。")
    ...
    @Schema(description = "结果快照。")
    private String resultSnapshotJson;

    @Schema(description = "首次请求 requestId。")
    private String requestId;

    @Schema(description = "过期时间；默认 24 小时，流程任务和导出任务 72 小时。")
