...
public class RequestContextFilter extends OncePerRequestFilter {
    ...
    protected RequestContext buildContext(HttpServletRequest request) {
        ...
        return RequestContext.builder()
                ...
                .systemId(request.getHeader(RequestContext.SYSTEM_ID_HEADER))
                .memberId(request.getHeader(RequestContext.MEMBER_ID_HEADER))
                .clientId(request.getHeader(RequestContext.CLIENT_ID_HEADER))
