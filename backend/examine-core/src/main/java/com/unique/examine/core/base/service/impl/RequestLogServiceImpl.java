...
import com.unique.examine.core.base.mapper.RequestLogMapper;
...
public class RequestLogServiceImpl extends ServiceImpl<RequestLogMapper, RequestLog>
     ...
     */
    @Override
    public RequestLog queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<RequestLog> queryPage(Page<RequestLog> page) {
    ...
    public boolean addOrUpdate(RequestLog entity) {
