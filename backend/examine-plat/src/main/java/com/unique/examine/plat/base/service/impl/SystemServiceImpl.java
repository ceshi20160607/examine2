...
/**
 * 自定义系统容器，承载系统编码、租户模式、创建人和状态。 基础 CRUD 服务实现。
 *
...
public class SystemServiceImpl extends ServiceImpl<SystemMapper, System>
     ...
     */
    @Override
    public System queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public IPage<System> queryPage(Page<System> page) {
    ...
    public boolean addOrUpdate(System entity) {
