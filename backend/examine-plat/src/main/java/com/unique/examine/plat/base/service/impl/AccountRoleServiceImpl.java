...
import com.unique.examine.plat.base.mapper.AccountRoleMapper;
...
public class AccountRoleServiceImpl extends ServiceImpl<AccountRoleMapper, AccountRole>
     ...
     */
    @Override
    public AccountRole queryById(Serializable id) {
        return getById(id);
    }
     ...
     */
    @Override
    public List<AccountRole> queryAll() {
        return list();
    }
     ...
     */
    @Override
    public IPage<AccountRole> queryPage(Page<AccountRole> page) {
    ...
    public boolean addOrUpdate(AccountRole entity) {
