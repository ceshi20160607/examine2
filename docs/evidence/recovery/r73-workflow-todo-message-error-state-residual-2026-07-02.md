...
- System/module/record: system=1024, module=422, record=592
- Flow: flow=139, publishCheck=True, simulation=True, simulationRuntimeInstanceCreated=False, steps=2
- Browser requester submit: pendingTask=83, pendingTodo=83, pendingMessage=85
...
- Reject path: system=1027, record=593, task=84, action=reject, detail=REJECTED, sidebar=REJECTED, pendingAfter=0, handledAfter=1
...
- Cleanup: 1024:DELETE, 1025:DELETE, 1026:DELETE, 1027:DELETE, 1028:DELETE, 1029:DELETE
