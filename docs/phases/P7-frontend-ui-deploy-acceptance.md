...
P7 通过。当前项目具备后端 jar、前端 dist 和组合 E2E 证据，可交给用户试部署与体验验收。旧包 `dist/unexamine-full-deploy-20260608-141816.zip` 和 `dist/unexamine-full-deploy-20260608-154616.zip` 已被新版 `dist/unexamine-full-deploy-20260608-164002.zip` 取代，部署时必须按 nginx 文档保留 `/api` 前缀并代理接口文档路径。
