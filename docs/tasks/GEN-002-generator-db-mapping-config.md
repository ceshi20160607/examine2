...
- 输出文件或输出目录: `backend/examine-generator/src/main/resources/generator/table-module-map.yml`

## 详细工作内容

- 读取 `docs/service_info.md` 中数据库连接来源。
- 参考 `GeneratorOwner` 的 `un_` 前缀识别方式，但改为当前项目可配置的数据源和模块映射。
