...
| P14-TEST-001 | test | 执行剧本 A 管理员到普通用户完整链路。 | `docs/test_runs/p14-integrated-api-e2e-20260611.md`、`docs/test_runs/p14-frontend-smoke-20260611.md` | API 链路完成建系统/建模/发布/运行台记录；浏览器完成登录、运行台进入模块和页面新增业务记录。 |
| P14-TEST-002 | test | 执行剧本 B 平台级对外应用链路。 | `docs/test_runs/p14-integrated-api-e2e-20260611.md`、`docs/test_runs/p14-frontend-smoke-20260611.md` | API 完成 OpenAPI scope 目录和对外应用创建；浏览器完成平台对外应用中心进入系统授权表单。 |
| P14-TEST-003 | test | 执行剧本 C 审计与恢复链路。 | `docs/test_runs/p14-integrated-api-e2e-20260611.md`、`docs/test_runs/p14-frontend-smoke-20260611.md` | API 完成平台/系统/OpenAPI 日志查询；浏览器完成日志入口分层和系统上下文隔离检查。 |
