...
| P6-final-acceptance | 集成验收与上线判断期 | in_progress | 8/14 契约同步检查已执行并失败，target=frontend | 启动 VAL-004 构建报告 |
...
| Validator | 3 | 0 | 1 | VAL-001 通过；VAL-002/VAL-003 已失败并指向 frontend；下一步 VAL-004 构建报告。 |
...
当前 `P6-final-acceptance` 已完成 FE-012、BE-015、TEST-003、TEST-004、TEST-005、VAL-001、VAL-002 和 VAL-003，下一步执行 VAL-004 构建报告。
