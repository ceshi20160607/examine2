...
function applySession(tenantId = '20') {
  useSessionStore().applyAuth({
    ...
    context: { type: 'SYSTEM', account: { id: '1', username: 'member', displayName: 'Member' }, systemId: '10', tenantId, memberId: '30', permissionVersion: '1', permissions: [], shells: ['SYSTEM_RUNTIME'] },
    systems: [],
  })
}
