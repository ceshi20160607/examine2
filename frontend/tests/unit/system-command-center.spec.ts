...
function applySession() {
  useSessionStore().applyAuth({
    ...
    systems: [
      { id: '10', code: 'pump_ops', name: '泵站系统', status: 'ACTIVE', memberStatus: 'ACTIVE', defaultTenantId: '20' },
      { id: '11', code: 'asset_ops', name: '资产系统', status: 'ACTIVE', memberStatus: 'ACTIVE', defaultTenantId: '21' },
    ],
  })
}
