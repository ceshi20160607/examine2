...
| `MONEY` | `money-input` | `money-input` | 两位金额 | number 或数值字符串 |
...
| `MEMBER` | `member-picker` | `member-picker` | 成员展示值 | id/object/array |
| `DEPT` | `dept-picker` | `dept-picker` | 部门展示值 | id/object/array |
