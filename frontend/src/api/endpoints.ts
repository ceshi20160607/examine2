...
export const API_ENDPOINTS = {
  ...
  "PLAT-013": defineEndpoint("PLAT-013", "platform", "GET", "/api/v1/platform/accounts/{accountId}"),
  "PLAT-014": defineEndpoint("PLAT-014", "platform", "PUT", "/api/v1/platform/accounts/{accountId}"),
  "PLAT-015": defineEndpoint("PLAT-015", "platform", "POST", "/api/v1/platform/accounts/{accountId}/password/reset"),
  "PLAT-016": defineEndpoint("PLAT-016", "platform", "PUT", "/api/v1/platform/accounts/{accountId}/roles"),
  "PLAT-017": defineEndpoint("PLAT-017", "platform", "POST", "/api/v1/platform/roles"),
  "PLAT-018": defineEndpoint("PLAT-018", "platform", "PUT", "/api/v1/platform/roles/{roleId}"),
  "PLAT-019": defineEndpoint("PLAT-019", "platform", "PATCH", "/api/v1/platform/roles/{roleId}/status"),
  "PLAT-020": defineEndpoint("PLAT-020", "platform", "GET", "/api/v1/platform/permission-catalog"),
  ...
  "RBAC-012": defineEndpoint("RBAC-012", "rbac", "GET", "/api/v1/systems/{systemId}/rbac/roles/{roleId}/permissions"),
  "RBAC-013": defineEndpoint("RBAC-013", "rbac", "GET", "/api/v1/systems/{systemId}/rbac/permission-catalog"),

  "DICT-001": defineEndpoint("DICT-001", "dict", "GET", "/api/v1/systems/{systemId}/dict/types"),
  "DICT-002": defineEndpoint("DICT-002", "dict", "POST", "/api/v1/systems/{systemId}/dict/types"),
  "DICT-003": defineEndpoint("DICT-003", "dict", "PUT", "/api/v1/systems/{systemId}/dict/types/{dictTypeId}"),
  "DICT-004": defineEndpoint("DICT-004", "dict", "PATCH", "/api/v1/systems/{systemId}/dict/types/{dictTypeId}/status"),
  "DICT-005": defineEndpoint("DICT-005", "dict", "GET", "/api/v1/systems/{systemId}/dict/types/{dictTypeId}/items"),
  "DICT-006": defineEndpoint("DICT-006", "dict", "POST", "/api/v1/systems/{systemId}/dict/types/{dictTypeId}/items"),
  "DICT-007": defineEndpoint("DICT-007", "dict", "PUT", "/api/v1/systems/{systemId}/dict/items/{dictItemId}"),
  "DICT-008": defineEndpoint("DICT-008", "dict", "PATCH", "/api/v1/systems/{systemId}/dict/items/{dictItemId}/status"),
  "DICT-009": defineEndpoint("DICT-009", "dict", "GET", "/api/v1/systems/{systemId}/dict/types/{dictTypeId}/usages"),
  "DICT-010": defineEndpoint("DICT-010", "dict", "DELETE", "/api/v1/systems/{systemId}/dict/types/{dictTypeId}"),
  "DICT-011": defineEndpoint("DICT-011", "dict", "DELETE", "/api/v1/systems/{systemId}/dict/items/{dictItemId}"),
  ...
  "APP-006": defineEndpoint("APP-006", "app", "POST", "/api/v1/systems/{systemId}/apps/{appId}/copy", "Bearer", "APP_COPY"),
  "APP-007": defineEndpoint("APP-007", "app", "GET", "/api/v1/systems/{systemId}/apps/templates", "Bearer", "APP_TEMPLATE_VIEW"),
  ...
  "UI-009": defineEndpoint("UI-009", "ui", "POST", "/api/v1/systems/{systemId}/modules/{moduleId}/ui/import", "Bearer", "PAGE_IMPORT"),
